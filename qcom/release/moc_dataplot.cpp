/****************************************************************************
** Meta object code from reading C++ file 'dataplot.h'
**
...
#error "The header file 'dataplot.h' doesn't include <QObject>."
...
const QMetaObject DataPlot::staticMetaObject = {
    { &QwtPlot::staticMetaObject, qt_meta_stringdata_DataPlot.data,
      qt_meta_data_DataPlot,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
